...
public:
    ...
    void opOraFrom(uint8_t rhs) {
        cpuA = static_cast<uint8_t>(cpuA | rhs);
        setCpuZN(cpuA);
    }

    void opAndFrom(uint8_t rhs) {
        cpuA = static_cast<uint8_t>(cpuA & rhs);
        setCpuZN(cpuA);
    }

    void opEorFrom(uint8_t rhs) {
        cpuA = static_cast<uint8_t>(cpuA ^ rhs);
        setCpuZN(cpuA);
    }
    ...
    bool executeDriveCpuMicroOpBaseOpcode(uint8_t op, uint8_t &cyclesUsed) {
        ...
        switch (op) {
            ...
            case 0xB6:
                ...
                return true;
            case 0xB7:
                cpuA = read(static_cast<uint8_t>(read(static_cast<uint16_t>(pc + 1)) + cpuY));
                cpuX = cpuA;
                setCpuZN(cpuA);
                pc = static_cast<uint16_t>(pc + 2);
                cyclesUsed = 4;
            ...
            case 0x95:
                ...
                return true;
            case 0x87:
                write(read(static_cast<uint16_t>(pc + 1)), static_cast<uint8_t>(cpuA & cpuX));
                pc = static_cast<uint16_t>(pc + 2);
                cyclesUsed = 3;
                return true;
            case 0x97:
                write(static_cast<uint8_t>(read(static_cast<uint16_t>(pc + 1)) + cpuY), static_cast<uint8_t>(cpuA & cpuX));
                pc = static_cast<uint16_t>(pc + 2);
                cyclesUsed = 4;
                return true;
            case 0x81: {
            ...
            case 0x83: {
                const uint8_t zpPtr = static_cast<uint8_t>(read(static_cast<uint16_t>(pc + 1)) + cpuX);
                write(read16ZeroPageWrap(zpPtr), static_cast<uint8_t>(cpuA & cpuX));
                pc = static_cast<uint16_t>(pc + 2);
                cyclesUsed = 6;
                return true;
            }
            case 0x8D:
                ...
                return true;
            case 0x8F:
                write(read16(static_cast<uint16_t>(pc + 1)), static_cast<uint8_t>(cpuA & cpuX));
                pc = static_cast<uint16_t>(pc + 3);
                cyclesUsed = 4;
                return true;
            case 0x91: {
            ...
            case 0x07: {
                const uint16_t addr = read(static_cast<uint16_t>(pc + 1));
                const uint8_t value = opAslValue(read(addr));
                write(addr, value);
                opOraFrom(value);
                pc = static_cast<uint16_t>(pc + 2);
                cyclesUsed = 5;
            ...
            case 0x1B: {
                const uint16_t addr = static_cast<uint16_t>(read16(static_cast<uint16_t>(pc + 1)) + cpuY);
                const uint8_t value = opAslValue(read(addr));
                write(addr, value);
                opOraFrom(value);
                pc = static_cast<uint16_t>(pc + 3);
            ...
            case 0x03: {
                const uint8_t zpPtr = static_cast<uint8_t>(read(static_cast<uint16_t>(pc + 1)) + cpuX);
                const uint16_t addr = read16ZeroPageWrap(zpPtr);
                const uint8_t value = opAslValue(read(addr));
                write(addr, value);
                opOraFrom(value);
                pc = static_cast<uint16_t>(pc + 2);
            ...
            case 0x47: {
                const uint16_t addr = read(static_cast<uint16_t>(pc + 1));
                const uint8_t value = opLsrValue(read(addr));
                write(addr, value);
                opEorFrom(value);
                pc = static_cast<uint16_t>(pc + 2);
                cyclesUsed = 5;
            ...
            case 0x27: {
                const uint16_t addr = read(static_cast<uint16_t>(pc + 1));
                const uint8_t value = opRolValue(read(addr));
                write(addr, value);
                opAndFrom(value);
                pc = static_cast<uint16_t>(pc + 2);
                cyclesUsed = 5;
            ...
            case 0x67: {
                const uint16_t addr = read(static_cast<uint16_t>(pc + 1));
                const uint8_t value = opRorValue(read(addr));
                write(addr, value);
                opAdc(value);
                pc = static_cast<uint16_t>(pc + 2);
                cyclesUsed = 5;
